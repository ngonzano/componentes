...
//estos se cambia para las animaciones
    ...
    return Scaffold(
      ...
      body: Center(
        child: AnimatedContainer(
          // un contenedor es para es como un div de html puede tener bordes fijos color de fondo etc
          duration: const Duration(
              milliseconds: 1000), // lo que demora en su transformacion
          curve: Curves.bounceOut, //revisar en la guia sus animaciones
          width: _width,
          height: _height,
          decoration: BoxDecoration(
              //color y cuanta curva tendra
              color: _color,
